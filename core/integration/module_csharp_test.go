...
public class Test
{
    ...
    {
        return Dag.Directory().WithNewFile("foo.txt", "bar");
    }

    [Function]
    public File ReturnFile()
    {
        return Dag.Directory().WithNewFile("test.txt", "content").File("test.txt");
    }
}
`)
...
{
    [Function]
    public string Echo(string message = "default")
    {
        return message;
    }
...
public class Test
{
    ...
    [Function]
    public string MyMethodName(string myParamName)
    {
        return $"{myParamName}:{MyFieldValue}";
    }
}
`)
...
{
    [Function]
    public CustomObject CreateCustom(string name)
    {
...
public class Test
{
    ...
    [Function]
    public float MultiplyFloat(float a, float b = 2.0F)
    {
        return a * b;
    }

    [Function]
    public double MultiplyDouble(double a, double b = 3.0)
    {
        return a * b;
    }
}
