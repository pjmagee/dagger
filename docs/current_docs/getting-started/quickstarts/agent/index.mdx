...
You can write your module in C#, Go, Python, TypeScript, PHP, or Java. Choose the SDK you are most comfortable with and run the command below to generate a new Dagger module:

<Tabs groupId="language" queryString="sdk">
<TabItem value="csharp" label="C#">
```shell
dagger init --sdk=csharp --name=coding-agent
```
</TabItem>
