---
slug: /extending/services
title: "Services"
description: "Learn how to use services in Dagger"
---
...
{
    [Function]
    public async Task<string> UserList(Service svc)
    {
...
{
    [Function]
    public async Task<Service> Services()
    {
        var svcA = Dag.Container()
            .From("nginx")
            .WithExposedPort(80)
            .AsService(new ContainerAsServiceOpts
            {
                Args = ["sh", "-c", "nginx & while true; do curl svcb:80 && sleep 1; done"]
            })
            .WithHostname("svca");
        await svcA.Start();
        
        var svcB = Dag.Container()
            .From("nginx")
            .WithExposedPort(80)
            .AsService(new ContainerAsServiceOpts
            {
                Args = ["sh", "-c", "nginx & while true; do curl svca:80 && sleep 1; done"]
            })
            .WithHostname("svcb");
        await svcB.Start();
...
```cs
// Inline C# code - converted from file reference: ./snippets/services/use-endpoint/csharp/Main.cs
// TODO: Add actual C# implementation
```
...
```cs
// Inline C# code - converted from file reference: ./snippets/services/persist-service-state/csharp/Main.cs
// TODO: Add actual C# implementation
```
...
```cs
// Inline C# code - converted from file reference: ./snippets/services/start-stop-services/csharp/Main.cs
// TODO: Add actual C# implementation
```
...
```cs
// Inline C# code - converted from file reference: ./snippets/services/test-against-db-service/csharp/Main.cs
// TODO: Add actual C# implementation
```
...
```cs
// Inline C# code - converted from file reference: ./snippets/services/service-lifecycle-1/csharp/Main.cs
// TODO: Add actual C# implementation
```
...
```cs
// Inline C# code - converted from file reference: ./snippets/services/service-lifecycle-2/csharp/Main.cs
// TODO: Add actual C# implementation
```
...
```cs
// Inline C# code - converted from file reference: ./snippets/services/service-lifecycle-3/csharp/Main.cs
// TODO: Add actual C# implementation
```
