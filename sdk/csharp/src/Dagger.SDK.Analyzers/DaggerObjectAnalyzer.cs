...
public class DaggerObjectAnalyzer : DiagnosticAnalyzer
{
    ...
    public override void Initialize(AnalysisContext context)
    {
        ...
        // Records (record class) are supported as module objects alongside
        // plain classes: at runtime they are reference types with a public
        // primary constructor and public init properties, which the reflection
        // registration already handles. Analyze both so records get the same
        // validation (XML docs, single public constructor, [Function] hints).
    ...
    private void AnalyzeTypeDeclaration(SyntaxNodeAnalysisContext context)
    {
        ...
        // (their shared base is TypeDeclarationSyntax).
