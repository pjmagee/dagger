        ...
        context.RegisterSourceOutput(
            ...
            (spc, sources) =>
            {
                ...
                try
                {
                    ...
                    var debugInfo = $"// Introspection loaded: types={introspection.Schema.Types.Length}\n" +
                                    "// First 5 types: " + string.Join(", ", introspection.Schema.Types.Take(5).Select(t => t.Name));
                    spc.AddSource("IntrospectionDebug.g.cs", SourceText.From(debugInfo, Encoding.UTF8));
