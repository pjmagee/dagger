...
public class DaggerObjectAnalyzerTests
{
    ...
    #region Records: [Object] on record class is analyzed like a class

    [TestMethod]
    public async Task Record_PublicMethodWithoutFunctionAttribute_ReportsDiagnostic()
    {
        var test = """
            using Dagger;

            /// <summary>My record module</summary>
            [Object]
    ...
    [TestMethod]
    public async Task PositionalRecord_WellFormed_NoDiagnostic()
    {
        // A positional record's primary constructor and init properties are
        // valid module surface: no analyzer diagnostics expected. The
        // compiler-generated copy constructor is protected, so the
        // multiple-public-constructors check must not fire.
        var test = """
            using Dagger;
