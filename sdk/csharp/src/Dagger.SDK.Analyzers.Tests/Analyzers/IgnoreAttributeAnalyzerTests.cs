...
public class IgnoreAttributeAnalyzerTests
{
    ...
    #region DAGGER010: [DefaultPath] can only be applied to Directory, File, GitRepository or GitRef parameters
    ...
    [TestMethod]
    public async Task DefaultPathAttribute_OnGitRepositoryParameter_NoDiagnostic()
    {
        var test = """
            using Dagger;
            ...
            {
                [Function]
                public string Build([DefaultPath(".")] GitRepository repo) => "built";
            }
            """;
    ...
    [TestMethod]
    public async Task DefaultPathAttribute_OnGitRefParameter_NoDiagnostic()
    {
        var test = """
            using Dagger;
            ...
            {
                [Function]
                public string Build([DefaultPath(".")] GitRef gitRef) => "built";
            }
            """;
