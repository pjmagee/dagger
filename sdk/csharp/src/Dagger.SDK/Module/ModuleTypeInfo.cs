...
internal sealed class ModuleTypeInfo
{
    ...
    /// <summary>
    /// Alternative constructor method marked with [Constructor] attribute.
    /// This is a static factory method that returns an instance of the module type.
    /// Takes precedence over Constructor if both are set.
    /// </summary>
    public MethodInfo? ConstructorMethod { get; set; }
...
internal sealed class FunctionInfo
{
    ...
    /// <summary>
    /// Custom API name from [Name] attribute, if specified.
    /// </summary>
...
internal sealed class ParameterMetadata
{
    ...
    /// <summary>
    /// Deprecation message if the parameter is marked with [Deprecated].
    /// </summary>
    public string? Deprecated { get; init; }
...
internal sealed class DaggerFieldInfo
{
    ...
    /// <summary>
    /// True when the property carries an explicit [Function] attribute (as
    /// opposed to being auto-exposed as a public property). Explicit fields
    /// fail registration hard when their type cannot be mapped; auto-exposed
